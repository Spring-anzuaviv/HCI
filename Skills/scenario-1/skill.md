---
name: scenario-1
description: Dùng để viết Scenario 1 (hệ thống hiện tại) cho đồ án HCI — mô tả tường thuật ca làm việc thực tế của nhân viên giặt ủi trước khi có hệ thống hỗ trợ, làm nổi bật các pain points từ Persona và Value Proposition Canvas.
---
...
- Làm nổi bật các pain points phát sinh trong tường thuật bằng cách kết nối chúng với Persona và Value Proposition Canvas.
...
- Value Proposition Canvas (Customer Jobs, Customer Pains, Customer Gains).
...
3. **Không mô tả giải pháp** — Scenario 1 chỉ mô tả hiện trạng. Không đề cập tính năng, hệ thống mới, hay cách khắc phục.
4. **Mỗi chi tiết trong tường thuật cần có nguồn** — nếu không truy được về finding hoặc synthesis, đánh dấu `[A]` hoặc bỏ đi.
5. **Ngôn ngữ của người dùng** — ưu tiên dùng thuật ngữ, cách diễn đạt mà người dùng dùng trong phỏng vấn (ví dụ: "đôn đơn", "bàn giao ca", "đơn gấp").
...
- [ ] Mỗi pain point trong callout có thể truy về ít nhất một chi tiết cụ thể trong tường thuật không?
- [ ] Mỗi pain point trong callout có khớp với Pain Points trong Persona hoặc Customer Pains trong Value Proposition Canvas không?
...
- **Pain points trong callout không khớp với Persona:** quay lại Persona và phỏng vấn, đối chiếu lại trước khi xuất.
