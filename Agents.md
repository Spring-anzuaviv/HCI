...
This project is indexed by GitNexus as **HCI** (1711 symbols, 3577 relationships, 139 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
